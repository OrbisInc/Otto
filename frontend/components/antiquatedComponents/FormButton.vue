<!-- The child component for the button that opens a modal form. This child component is called and utilzed by multiple different parent components and widgets:
Announcement, Deployments, Birthdays.

This form uses a POST Ajax request to try and add data to the database through multiple URLS which are defined and passed as a prop.
 -->
...
<template>
  <div>
    <transition name="modal">
      <div v-if="isOpen">
        <div class="overlay" @click.self="isOpen = false;">
          ...
          <div :class="'modal ' + (isOpen ? 'is--visible': '')">
    ...
    <button class="btn__default--text btn--info" @click="isOpen = !isOpen;">
      {{ isOpen ? "Close" : this.buttonText }} 
    </button>
  </div>
</template>
