...
<script>
  ...
  export default {
    ...
    methods: {
      // constructor() will utilize the props (arguments) taken in by the component, and parse them into the related attributes for this event item for display in the template.
